...
var Component =  ( function () {
        ...
        return {
          ...
          TodoApp : Lifted(function TodoApp(props,state) {
                  ...
                  if(_13) {
                    var _18 = getTodoApp_todos(state,scope.app);
                    var oldScope = scope;
                    var _20 = [];
                    for (var _21 = 0 ; _21 < _18.length ; _21++) {
                       ( function () {
                              var scope = _.assign({
                              },oldScope,{
                                todo : _18[_21]
                              });
                              var _19 = React.createElement(Component.TodoItem,{
                                todo : scope.todo
                              });
                              _20.push(_.assign({
                              },_19,{
                    ...
                    var _16 = React.createElement("ul",{
                      className : "todo-list"
                    },_20);
                  ...
                  var _23 = React.createElement(Component.TodoFooter,{
                    app : scope.app
                  });
