...
function invalidateTodo_finished(state,id) {
  scoped(scope,{
    $this : id
          ...
          if(_0 != null) {
            state = invalidateTodoApp_allFinished(state,_0);
          }
      });
  scoped(scope,{
    $this : id
...
var Component =  ( function () {
        ...
        return {
          ...
          TodoApp : Lifted(function TodoApp(props,state) {
                  ...
                  var _19 ;
                  var _8 = getTodoApp_todos(state,scope.app);
                  var _9 = expression.count(_8);
                  var _10 = _9 !== null ? _9 > 0 : null;
                  if(_10) {
                    var _15 ;
                    if(scope.app != null) {
                    ...
                    for (var _18 = 0 ; _18 < _15.length ; _18++) {
                       ( function () {
                              ...
                              var _16 = React.createElement(Component.TodoItem,{
                                todo : scope.todo
                              });
                              _17.push(_.assign({
                              },_16,{
                    ...
                    var _13 = React.createElement("ul",{
                      className : "todo-list"
                    },_17);
                    var _11 = React.createElement("section",{
                      className : "main"
                    },_13);
                    _19 = _11;
                  } else {
