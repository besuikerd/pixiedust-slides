...
function getAdd_equation(state,id) {
  return state.get("Add_equation").get(id);
}

module.exports.getAdd_equation = getAdd_equation;
function getAdd_equation_Many(state,ids) {
  var _0 = [];
  var _2 = state.get("Add_equation");
...
module.exports.getAdd_equation_Many = getAdd_equation_Many;
...
function invalidateAdd_equation(state,id) {
  state = state.update("Add_equation",function (set) {
          return set.remove(id);
      });
  return state;
}

module.exports.invalidateAdd_equation = invalidateAdd_equation;
function invalidateAdd_value(state,id) {
  state = state.update("Add_value",function (set) {
          return set.remove(id);
      });
  if(id != null) {
    state = invalidateAdd_equation(state,id);
  }
  return state;
}
    ...
    $this : id
          ...
          if(_0 != null) {
            for (var i = 0 ; i < _0.length ; i++) {
              state = invalidateAdd_equation(state,_0[i]);
            }
          }
      });
  scoped(scope,{
...
function calculateAdd_equation(state,id) {
  var result = getAdd_equation(state,id);
  if(result === undefined) {
    scoped(scope,{
      $this : id
    },function (scope) {
            var _3 = getAdd_lhs(state,scope["$this"]);
            var _4 ;
            if(_3 != null) {
            ...
            var _5 = getAdd_rhs(state,scope["$this"]);
            var _6 ;
            if(_5 != null) {
              var calc = calculateCounter_value(state,_5);
              state = calc.state;
              _6 = calc.result;
            } else {
              _6 = null;
            ...
            var _7 ;
            if(scope["$this"] != null) {
              var calc = calculateAdd_value(state,scope["$this"]);
              state = calc.state;
              _7 = calc.result;
            } else {
              _7 = null;
            }
            var _1 = React.createElement("span",{
            },_4," + ",_6," = ",_7);
            result = _1;
            state = state.update("Add_equation",function (table) {
...
module.exports.calculateAdd_equation = calculateAdd_equation;
function calculateAdd_equation_Many(state,ids) {
  var result = [];
  for (var i = 0 ; i < ids.length ; i++) {
    var id = ids[i];
    var calc = calculateAdd_equation(state,id);
    state = calc.state;
    if(calc.result !== null) {
...
module.exports.calculateAdd_equation_Many = calculateAdd_equation_Many;
...
var actions = {
  ...
  "calculateAdd_equation" : function (state,action) {
          return calculateAdd_equation(state,action.id).state;
      },
  "calculateAdd_equation_Many" : function (state,action) {
          return calculateAdd_equation_Many(state,action.ids).state;
      },
...
var actionCreators = {
  ...
  "calculateAdd_equation" : function (id) {
          return {
            type : "calculateAdd_equation",
            id : id
          };
      },
  "calculateAdd_equation_Many" : function (ids) {
          return {
            type : "calculateAdd_equation_Many",
            id : ids
          };
      },
...
var Component =  ( function () {
        ...
        return {
          ...
          Add : Lifted(function Add(props,state,store) {
                  ...
                  var _1 = getAdd_lhs(state,scope.add);
                  var _0 = React.createElement(Component.Counter,{
                    c : _1
                  });
                  var _3 = getAdd_rhs(state,scope.add);
                  var _2 = React.createElement(Component.Counter,{
                    c : _3
                  });
                  var _4 ;
                  if(scope.add != null) {
                    var calc = calculateAdd_equation(state,scope.add);
                    state = calc.state;
                    _4 = calc.result;
                  } else {
                    _4 = null;
    ...
    by : action.args[0]
          ...
          scoped(scope,{
            $this : scope.c
                  ...
                  var _1 ;
                  if(scope["$this"] != null) {
                    var calc = calculateCounter_value(state,scope["$this"]);
                    state = calc.state;
                    _1 = calc.result;
                  } else {
                    _1 = null;
                  }
                  var _2 = _1 !== null && scope.by !== null ? _1 + scope.by : null;
                  newState = setCounter_value(newState,scope["$this"],_2);
              });
      });
  return newState;
}
