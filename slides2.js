  ...
  scoped(scope,_.assign({
          ...
          scoped(scope,{
            $this : _159.id
                  ...
                  var _164 = React.createElement("li",{
                  },"Content");
                  var _166 = React.createElement("li",{
                  },"Content");
                  var _168 = React.createElement("li",{
                  },"Content");
                  var _170 = React.createElement("li",{
                  },"Content");
                  var _162 = React.createElement("ul",{
                  },_164,_166,_168,_170);
                  var _160 = React.createElement("div",{
                  },_162);
            ...
            intro : _159.id
                  ...
                  scoped(scope,{
                    $this : _148.id
                          ...
                          var _151 = React.createElement(imports["./components/CodeBlock"].CodeBlockFetch,{
                            language : "pix",
                            url : "/sources/counter_model.pix"
                          });
                          var _152 = React.createElement("div",{
                          });
                          var _150 = React.createElement(Component.TwoColumn,{
                            left : _151,
                            right : _152
                          });
                          newState = setSlide_content(newState,scope["$this"],_150);
                    ...
                    counter1 : _148.id
                          ...
                          scoped(scope,{
                            $this : _140.id
                                  ...
                                  var _142 = React.createElement(imports["./examples/main"].SlidesExample,{
                                  });
                                  var _143 = React.createElement(imports["./examples/main"].SlidesExample,{
                                  });
                            ...
                            slides : _140.id
                                  ...
                                  scoped(scope,{
                                    $this : _130.id
                                          ...
                                          newState = setSlide_slideshow(newState,scope["$this"],scope.slideshow);
                                          newState = setSlide_title(newState,scope["$this"],"Counter Example (not a counterexample)");
                                          var _133 = React.createElement(imports["./components/CodeBlock"].CodeBlockFetch,{
                                            language : "pix",
                                            url : "/sources/counter_model.pix"
                                          });
                                          var _136 = React.createElement(imports["./examples/main"].CounterExample,{
                                          });
                                          var _134 = React.createElement("div",{
                                          },_136);
                                          var _132 = React.createElement(Component.TwoColumn,{
                                            left : _133,
                                            right : _134
                                          });
                                          newState = setSlide_content(newState,scope["$this"],_132);
